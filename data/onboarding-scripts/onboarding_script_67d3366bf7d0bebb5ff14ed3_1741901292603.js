/**
 * WaterLoo Application Approvals Guided Tour
...
(function() {
  ...
  const tourSteps = [
    {
      element: '.navbar-brand', // WaterLoo logo
      title: 'Welcome to Application Approvals',
      content: 'This is the administrative interface for managing application approvals. Let\'s explore the key features.',
      position: 'right',
      showClick: false,
      buttonText: 'Get Started'
    },
    {
      element: '.card:nth-child(1)', // Pending card
      title: 'Pending Applications',
      content: 'This counter shows how many applications are currently pending your review.',
      position: 'bottom',
      showClick: false,
      buttonText: 'Next'
    },
    {
      element: '.card:nth-child(2)', // Approved card
      title: 'Approved Applications',
      content: 'This shows the total number of applications you have approved.',
      position: 'bottom',
      showClick: false,
      buttonText: 'Next'
    },
    {
      element: '.card:nth-child(3)', // Returned card
      title: 'Returned Applications',
      content: 'Applications that need corrections are returned to the submitter and counted here.',
      position: 'bottom',
      showClick: false,
      buttonText: 'Next'
    },
    {
      element: '.card:nth-child(4)', // Today card
      title: 'Today\'s Activity',
      content: 'This shows the number of applications processed today.',
      position: 'bottom',
      showClick: false,
      buttonText: 'Next'
    },
    {
      element: 'h3:contains("Pending Approvals")', // Pending Approvals section
      title: 'Pending Approvals Section',
      content: 'This table displays all applications waiting for your review and approval.',
      position: 'bottom',
      showClick: false,
      buttonText: 'Next'
    },
    {
      element: '.btn-sm.btn-outline-secondary', // Refresh button
      title: 'Refresh Data',
      content: 'Click this button to refresh the list and see any new applications that have been submitted.',
      position: 'left',
      showClick: true,
      buttonText: 'Next'
    },
    {
      element: 'table', // Applications table
      title: 'Applications Table',
      content: 'When applications are submitted, they will appear in this table for your review.',
      position: 'top',
      showClick: false,
      buttonText: 'Next'
    },
    {
      element: 'th:contains("Actions")', // Actions column
      title: 'Application Actions',
      content: 'When applications are available, you\'ll see action buttons here to approve, return, or view details.',
      position: 'left',
      showClick: false,
      buttonText: 'Next'
    },
    {
      element: 'h3:contains("Recent Activity")', // Recent Activity section
      title: 'Recent Activity',
      content: 'This section shows a history of your recent actions on applications.',
      position: 'top',
      showClick: false,
      buttonText: 'Next'
    },
    {
      element: '.list-group-item', // Activity item
      title: 'Activity Log',
      content: 'Each entry shows what action was taken, on which application, and when it occurred.',
      position: 'top',
      showClick: false,
