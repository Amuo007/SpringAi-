...
(function() {
  ...
  const tourSteps = [
    {
      element: '.btn-primary.btn-sm',
      title: 'Manage Your Signature',
      content: 'Start by setting up your digital signature. This is required for submitting applications and will be used to authenticate your documents.',
      position: 'right',
      showClick: true,
      buttonText: 'Got It'
    },
    {
      element: '#checkSignatureBtn',
      title: 'Create New Applications',
      content: 'Click here to start a new application. You can choose from different form types based on your needs.',
      position: 'bottom',
      showClick: true,
    ...
    },
    {
      ...
      content: 'This table displays all your submitted applications. You can track their status and access them at any time.',
      position: 'top',
      showClick: false,
      buttonText: 'Continue'
    },
    {
      ...
      content: 'Each row shows important details about your application, including its name, type, submission date, and current status.',
      position: 'bottom',
      showClick: false,
      buttonText: 'I See'
    },
    {
      element: 'td:contains("Status")',
      title: 'Track Application Status',
      content: 'Monitor the approval status of your applications here. You\'ll see updates as your application progresses through the workflow.',
      position: 'left',
      showClick: false,
      buttonText: 'Next'
    },
    {
      element: '.btn-sm.btn-outline-primary',
      title: 'Download Applications',
      content: 'Need a copy of your application? Click this button to download a PDF version for your records.',
      position: 'left',
      showClick: true,
      buttonText: 'Almost Done'
    },
    {
      element: '.btn-sm.btn-outline-info',
      title: 'View Application Details',
      content: 'Click here to view the complete details of your submitted application at any time.',
      position: 'left',
      showClick: true,
