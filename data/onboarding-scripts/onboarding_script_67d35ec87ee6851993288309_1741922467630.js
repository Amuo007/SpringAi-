  ...
  const tourSteps = [
    {
      ...
      title: 'Welcome to SpringAI',
      content: 'This is your SpringAI dashboard where you can manage all your AI-powered projects in one place.',
      position: 'bottom',
      showClick: false,
      buttonText: 'Got It'
    },
    {
      ...
      title: 'Your Account',
      content: 'Access your account settings and logout options from this dropdown menu.',
      position: 'bottom',
      showClick: true,
    ...
    },
    {
      element: 'h1',
      title: 'Your Projects',
      content: 'This is where all your SpringAI projects are displayed. You can quickly access any project from here.',
      position: 'right',
      showClick: false,
      buttonText: 'Continue'
    },
    {
      element: 'a.card-link:contains("Create a project")',
      title: 'Create New Projects',
      content: 'Start a new AI project by clicking here. You can create multiple projects for different use cases.',
      position: 'right',
      showClick: true,
      buttonText: 'Next'
    },
    {
      element: 'a.card-link:contains("SpringAi")',
      title: 'Access Your Projects',
      content: 'Click on any project card to open it and continue working on your AI solutions.',
      position: 'left',
      showClick: true,
      buttonText: 'Almost Done'
    },
    {
      element: '.card-link:contains("Created:")',
      title: 'Project Information',
      content: 'Each card shows the project name and creation date to help you stay organized.',
      position: 'top',
      showClick: false,
