...
(function() {
  ...
  const tourSteps = [
    {
      element: 'h1:contains("Project")',
      title: 'Welcome to Your Project Dashboard',
      content: 'This is your project control center where you can manage all aspects of your PROTOTYPE-ION project.',
      position: 'bottom',
      showClick: false,
      buttonText: 'Got It'
    },
    {
      ...
      content: 'Use these tabs to navigate between different sections of your project: Overview, Pages, Data, and Script.',
      position: 'bottom',
      showClick: false,
      buttonText: 'Next'
    },
    {
      element: '.nav-link:contains("Overview")',
      title: 'Project Overview',
      content: 'The Overview tab provides a summary of your project status and key metrics.',
      position: 'bottom',
      showClick: true,
      buttonText: 'Continue'
    },
    {
      ...
      content: 'Click here to view detailed information about your tracking script and how it\'s performing.',
      position: 'right',
      showClick: true,
      buttonText: 'Next Step'
    },
    {
      element: '.btn-secondary:contains("View Installation Code")',
      title: 'Installation Code',
      content: 'Need to add tracking to more pages? Click here to get the installation code for your script.',
      position: 'right',
      showClick: true,
      buttonText: 'Continue'
    },
    {
      element: 'table',
      title: 'Tracked Pages',
      content: 'This table shows all the pages currently being tracked by your script, along with their status.',
      position: 'top',
      showClick: false,
      buttonText: 'I See'
    },
    {
      element: '.btn-sm.btn-secondary',
      title: 'Page Details',
      content: 'Click "View Details" to see comprehensive analytics for any specific page.',
      position: 'left',
      showClick: true,
      buttonText: 'Next'
    },
    {
      element: '.btn-primary:contains("Export Data")',
      title: 'Export Your Data',
      content: 'Download all your collected data for offline analysis or reporting.',
      position: 'bottom',
      showClick: true,
      buttonText: 'Almost Done'
    },
    {
      element: '.btn-secondary:contains("View Analytics")',
      title: 'Advanced Analytics',
      content: 'Dive deeper into your data with comprehensive analytics and visualization tools.',
      position: 'bottom',
      showClick: true,
